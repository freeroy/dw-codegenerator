...
package ${basePackage}.${projectName}.site.${jspBasePath}.${moduleName};
 ...
 * 
 */
@Controller("/${jspBasePath}/${moduleName}/${objectName}Controller")
@RequestMapping("/${jspBasePath}/${moduleName}/${objectName}")
